			 ...
			 <input type="hidden" name="op" value="addUser">
				<ul class="forminfo">
					...
					<li>
						<li>
							<label>真实姓名</label>
							<input name="name" type="text" class="dfinput" /><i></i></li>
						<li>
							<label>性别</label><cite>
						...
						<li>
							...
							<input name="isjob" type="radio" value="1" checked="checked" />是&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="isjob" type="radio" value="0" />否</cite>
						</li>
						<li>
						...
						<li>
							...
							<div class="vocation">
								<select class="select1" name="did">
									<c:forEach items="${sessionScope.deptss}" var="d">
						...
						<li>
							...
							<div class="vocation">
								<select class="select1" name="jid">
									<c:forEach items="${sessionScope.jobss}" var="j">
									   <option value="${j.id}">${j.jname}</option>
									</c:forEach>
								</select>
							</div>
						...
						<li>
							<label>紧急联系人信息</label>
							<textarea name="contacts" cols="" rows="" id="ecp" class="textinput"></textarea>
						</li>
						<li>
							<label>身份证号</label>
